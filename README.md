...
- **Frontend:** el dashboard de gráficas y el buscador conversacional son el entregable de presentación pero el código del frontend no está en este repositorio todavía. El API está completo y documentado en `openapi.yaml`.
---
...
| Métrica | Valor |
|---|---|
| Accuracy buscador conversacional (40 preguntas, respuesta verificable) | 85% (34/40) |
